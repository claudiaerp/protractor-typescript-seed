# Protractor with Typescript seed
Repository based on [Angular Protractor Typescript example](https://github.com/angular/protractor/tree/master/exampleTypescript).
